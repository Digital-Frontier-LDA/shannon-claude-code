...
- playwright (Playwright): To interact with the live web application at the target.
  - **CRITICAL RULE:** For all browser interactions, you MUST use the playwright (Playwright).
...
2.  **Interactive Application Exploration:**
    - Use `playwright__browser_navigate` to navigate to the target.
