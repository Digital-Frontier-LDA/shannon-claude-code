---
name: shannon-vuln-authz
description: Authorization vulnerability analysis. Requires recon deliverable.
...
- **playwright (Playwright):** To interact with the live web application to understand multi-step flows and role-based access controls.
