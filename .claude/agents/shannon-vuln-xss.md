---
name: shannon-vuln-xss
description: Cross-Site Scripting (XSS) vulnerability analysis. Requires recon deliverable.
...
- **playwright (Playwright):** MANDATORY for testing DOM-based XSS and form submission vectors. Use for stored XSS testing and client-side payload execution verification.
